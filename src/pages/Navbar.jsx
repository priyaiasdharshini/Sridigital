      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        >
          <li className="md:inline-block block text-center">
            <Link
              to="/"
              className="block py-3 md:py-1 px-4 md:px-2 text-base md:text-lg font-medium hover:bg-orange-700 md:hover:bg-transparent hover:text-yellow-300 transition-all duration-200 rounded-md"
